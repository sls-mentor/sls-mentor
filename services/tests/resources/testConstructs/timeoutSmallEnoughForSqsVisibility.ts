...
import { timeoutSmallEnoughForSqsVisibility as TimeoutSmallEnoughForSqsVisibilityRule } from '@sls-mentor/rules';

import { DefaultFunction, DefaultSqsQueue } from '../defaultConstructs';
