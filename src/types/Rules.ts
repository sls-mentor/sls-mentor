...
export const ErrorMessages = {
  ...
  [Rules.NO_MAX_TIMEOUT]:
    'The following functions have their timeout set as the maximum.\nSee (https://github.com/Kumo-by-Theodo/guardian/blob/master/docs/rules/no-max-timeout.md) for impact and how to to resolve.',
  [Rules.NO_SHARED_IAM_ROLES]:
    'The following functions have roles used by 1 or more other functions.\nSee (https://github.com/Kumo-by-Theodo/guardian/blob/master/docs/rules/no-shared-iam-roles.md) for impact and how to to resolve.',
  [Rules.USE_ARM_ARCHITECTURE]:
    "The function's architecture is not set as ARM.\nSee (https://github.com/Kumo-by-Theodo/guardian/blob/master/docs/rules/use-arm.md) for impact and how to to resolve.",
  [Rules.UNDER_MAX_MEMORY]: `The function's memory is set to the historical maximum limit of ${AWS_HISTORICAL_MAX_MEMORY} MB or higher.\nSee (https://github.com/Kumo-by-Theodo/guardian/blob/master/docs/rules/under-max-memory.md) for impact and how to to resolve.`,
  [Rules.NO_IDENTICAL_CODE]:
    "The function's code is identical to other functions.\nSee (https://github.com/Kumo-by-Theodo/guardian/blob/master/docs/rules/no-identical-code.md) for impact and how to to resolve.",
  [Rules.INTELLIGENT_TIERING]:
    'Intelligent Tiering is not enabled on this S3 bucket.\nSee (https://github.com/Kumo-by-Theodo/guardian/blob/master/docs/rules/use-intelligent-tiering.md) for impact and how to to resolve.',
  [Rules.ASYNC_SPECIFY_FAILURE_DESTINATION]:
    'The function is asynchronous but has no failure destination set. See (https://github.com/Kumo-by-Theodo/guardian/blob/master/docs/rules/async-specify-failure-destination.md) for impact and how to to resolve.',
} as const;
